...
def compute_bone_transforms_euler(
    ...
    transform_values = {
        ...
        'hand_r': {
            ...
            'Rotation': [ -0.59294, -0.05397, -0.08010,  0.79940],# -0.59294, -0.05397, -0.08010,  0.79940
            'Scale': [1.0, 1.0, 1.0]
        },
        'hand_l': {
            'Location': [26.095160, -0.000000, 0.000000],
            'Rotation': [ -0.59294, -0.05397, -0.08010,  0.79940],
            'Scale': [1.0, 1.0, 1.0]
        },
        'thigh_r': {
        ...
        'thigh_l': {
            ...
            'Rotation': [0.07294364, 0.02387367, 0.04019042, 0.99623993],
            'Scale': [1.0, 1.0, 1.0]
        },
        'calf_r': {
